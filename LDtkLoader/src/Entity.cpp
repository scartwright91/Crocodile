...
#include "../include/LDtkLoader/Entity.hpp"
#include "../include/LDtkLoader/World.hpp"
#include "json.hpp"

using namespace ldtk;

Entity::Entity(const nlohmann::json &j, const World *w) : FieldsContainer(j["fieldInstances"], w),
...
{
    return m_definition->nine_slice_borders.top != -1 && m_definition->nine_slice_borders.right != -1 && m_definition->nine_slice_borders.bottom != -1 && m_definition->nine_slice_borders.left != -1;
}
