...
#include "../include/LDtkLoader/Enum.hpp"
#include "../include/LDtkLoader/Tileset.hpp"
#include "../include/LDtkLoader/Utils.hpp"
#include "json.hpp"

using namespace ldtk;

EnumValue::EnumValue(std::string val_name, int val_id, int val_tile_id, const Color &val_color, const Enum &val_enum_type) : name(std::move(val_name)),
                                                                                                                             color(val_color),
                                                                                                                             type(val_enum_type),
                                                                                                                             id(val_id),
                                                                                                                             tile_id(val_tile_id)
...
Enum::Enum(const nlohmann::json &j) : TagsContainer(j.contains("tags") ? j["tags"] : nlohmann::json{}),
