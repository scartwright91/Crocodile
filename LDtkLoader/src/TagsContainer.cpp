...
#include "../include/LDtkLoader/containers/TagsContainer.hpp"

#include "json.hpp"

using namespace ldtk;

TagsContainer::TagsContainer(const nlohmann::json &j) : m_tags(j.empty() ? std::vector<std::string>{} : j.get<std::vector<std::string>>())
{
}
