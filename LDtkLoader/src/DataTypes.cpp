...
#include "../include/LDtkLoader/DataTypes.hpp"

#include <utility>

using namespace ldtk;

Color::Color(unsigned int red, unsigned int green, unsigned int blue, unsigned int alpha) : r(red & 0xffu),
                                                                                            g(green & 0xffu),
                                                                                            b(blue & 0xffu),
                                                                                            a(alpha & 0xffu)
{
...
Color::Color(const std::string &hex) : Color(std::stoul(hex.substr(1, 2), nullptr, 16),
...
EntityRef::EntityRef(IID ent, IID layer, IID level, IID world) : entity_iid(std::move(ent)),
