...
Layer::Layer(const nlohmann::json &j, const World *w, const Level *l) : level(l),
...
{
    return m_override_tileset == nullptr ? (m_definition->m_tileset == nullptr ? *m_definition->m_auto_tileset : *m_definition->m_tileset) : *m_override_tileset;
}
